...
//import com.example.officeol.config.WordFile;
//
...
//        if(WordFile.wordFile.findWordOnOpen(fileId)==false) {//open a new file
//            NewWord newWord=new NewWord(userId,fileId);
//            WordFile.wordFile.WordFiles.add(newWord);
...
//            for(String message:WordFile.wordFile.getWord(fileId).contents)//重载
...
//        }
//        else if(WordFile.wordFile.findUserOnOpen(fileId,userId)==false){//a new user join a existed file
//            User user=new User(userId);
//            WordFile.wordFile.getWord(fileId).users.add(user);
//            Map<String,Object> map = new HashMap<String, Object>();
//            map.put("userId",userId);
//            map.put("mType","onOpen");
//            ArrayList<String> messages=new ArrayList<>();
//            for(String message:WordFile.wordFile.getWord(fileId).contents)
...
////                    WordFile.wordFile.getWord(ops.getFileId()).contents.clear();
////                    WordFile.wordFile.getWord(ops.getFileId()).contents.add(ops.getMessage());
...
////                else {
////                    try{
////                        Ops ops=new Ops(filethis.sendMessagetoAll(fileId,JSON.toJSONString(map1));Id,userId,textMessage,fileType);
////                        WordFile.wordFile.getWord(ops.getFileId()).addContents(ops.getMessage());
////                        FileToWebsocket.get(ops.getFileId()).add(this);
...
//        for(NewWord word:WordFile.wordFile.WordFiles){
